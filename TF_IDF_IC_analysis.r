...
## this code will run on the demo data, however, the results will not be as meaningful as on the full DDD data
...
termns <- c(names(informativePhenotypicTerms), unlist(sapply(informativePhenotypicTerms,names)));
...
topRank <- 300; ## 800 was used in the DDD analysis where more HPO terms were used
